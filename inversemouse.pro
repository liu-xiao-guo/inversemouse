...
UBUNTU_TRANSLATION_DOMAIN="inversemouse.liu-xiao-guo"
...
aptest.commands = bash $$PWD/inversemouse/tests/autopilot/run
aptest.depends  = sub-inversemouse

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/inversemouse/tests/unit
unittest.depends  = sub-inversemouse
